...
#define STRING_CONFIG_H_AUTHOR "Dejan" // Who made the changes.
...
#define XYZ_PULLEY_TEETH 8

// delta speeds must be the same on xyz
#define XYZ_STEPS 1600
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 3348.360 }
